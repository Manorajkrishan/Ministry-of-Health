...
export default function AddBabies() {
  ...
  const addBaby = (e) => {
    ...
    axios.post("http://localhost:8010/babydetails/addbaby", newBaby)
      .then(() => {
        alert("Baby Added");
        navigate("/allbaby");
      })
          ...
          <div className="col">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                <li className="breadcrumb-item"><a href="/allbaby">Add Baby</a></li>
                <li className="breadcrumb-item active">New Baby</li>
              </ol>
            </nav>
          </div>
...
/>
        ...
        <div className="row form-group mb-4">
          <div className="col">
            ...
            <input type="text" className="form-control" id="BloodType" name="BloodType" placeholder="Blood Type" onChange={(e) => {
          ...
          <div className="col">
            ...
            <input type="text" className="form-control" id="Allergies" name="Allergies" placeholder="Allergies" onChange={(e) => {
        ...
        <div className="form-group mb-4">
          ...
          <input type="email" className="form-control" name="Email" id="Email" placeholder="Email" onChange={(e) => {
        ...
        <div className="form-group mb-4">
          ...
          <textarea className="form-control" name="Address" id="Address" cols="10" rows="6" placeholder="Address" onChange={(e) => {
