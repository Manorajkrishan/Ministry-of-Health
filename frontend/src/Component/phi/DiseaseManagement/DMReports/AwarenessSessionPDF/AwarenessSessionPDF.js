...
function AwarenessSessionPDF() {
    ...
    function getSession() {
        axios.get(`http://localhost:8070/session/display`).then((res) => {
            setSession(res.data)
            // }).catch((err) => {
            //     alert(err)
            // })
    ...
    const handleDelete = (id) => {
        axios.delete(`http://localhost:8070/session/delete/${id}`).then(() => {
    ...
    const handleSearchArea = (e) => {
        ...
        axios.get(`http://localhost:8070/session/display`, {
